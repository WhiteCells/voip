#ifndef _AGENT_AUD_AUDIOMEDIAPORT_H_
#define _AGENT_AUD_AUDIOMEDIAPORT_H_
...
class AgentAudAudioMediaPort : public pj::AudioMediaPort
{
public:
    AgentAudAudioMediaPort();
    ~AgentAudAudioMediaPort();
...
#endif // _AGENT_AUD_AUDIOMEDIAPORT_H_
